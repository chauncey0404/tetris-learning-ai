...
# V8.8.7 A/B MICRO-PILOT — A: TD-ONLY CONTROL (2026-09-01)
# Base: formal V8.8.6 31.2M Champion.
# Goal: +250K transitions with the unchanged V8.8.6 recipe.
# This is the same-budget control for the ranking-aux treatment.
...
def main():
    ...
    parser.add_argument(
        ...
        default=250000,
        help=(
            "NEW transitions. A/B micro-pilot: 31.2M -> 31.45M."
        ),
    )
    parser.add_argument(
        "--start-seed",
    ...
    parser.add_argument(
        ...
        default=50872320,
        help=(
            "Preserves 203.48928 replay samples/new transition: "
            "250,000 transitions = 50,872,320 samples = 6,210 gradients."
        ),
    )
    ...
    parser.add_argument(
        "--checkpoint-prefix",
        default="models/v8_8_7_ab_td_control",
    )
    parser.add_argument(
        "--max-batch-fraction",
        type=float,
    ...
    parser.add_argument(
        "--output",
        default="models/v8_8_7_ab_td_control_31450k.pt",
    )
    parser.add_argument(
        "--parity-stamp",
    ...
    if args.steps == 250_000 and args.sample_budget != 50_872_320:
        raise RuntimeError(
            "A/B CONTROL RECIPE MISMATCH: +250K requires "
    ...
    print()
    print("V8.8.7 A/B MICRO-PILOT — TD-ONLY CONTROL 31.45M: PASS")
    print(
        "NOTE: this is a same-budget DEVELOPMENT CONTROL only. "
        "The formal 31.2M Champion remains unchanged."
    )
