...
# Allow both:
#   python -m singleplayer.tools.watch_models ...
# and:
#   python singleplayer\tools\watch_models.py ...
PROJECT_ROOT = Path(__file__).resolve().parents[2]
if str(PROJECT_ROOT) not in sys.path:
    sys.path.insert(0, str(PROJECT_ROOT))


from singleplayer.game.gym_adapter import GymTetrisAdapter
from singleplayer.game.executor import execute_placement
from singleplayer.game.placement import (
    get_rotations,
    piece_for_placement,
    simulate_placement,
)
from singleplayer.heuristic.teacher import HeuristicTeacherV2
from singleplayer.network.candidates import compact_candidate_arrays
...
from singleplayer.policy.legacy_raw_margin import conservative_choice
from singleplayer.policy.successor import preview_top_k_successors
