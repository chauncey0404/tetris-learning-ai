...
def main():
    ...
    parser.add_argument(
        "--checkpoint-prefix",
        default="models/v8_8_7_ranking_aux_pilot",
    )
    parser.add_argument(
        "--max-batch-fraction",
        type=float,
    ...
    parser.add_argument(
        "--output",
        default="models/v8_8_7_ranking_aux_pilot_31450k.pt",
    )
    parser.add_argument(
        "--ranking-corpus",
        default="data/v8_8_7_ranking_corpus_4761_4775.npz",
    )
    parser.add_argument("--ranking-weight", type=float, default=0.02)
    ...
    parser.add_argument(
        ...
        type=int,
        default=8,
        help="One ranking optimizer step every N TD gradients.",
    )
    ...
    def _learner_step():
        ...
        if new_gradient_steps % args.ranking_every == 0:
    ...
    print()
    print("V8.8.7 RANKING-AUX 31.2M -> 31.45M PILOT TRAINING: PASS")
    print(
