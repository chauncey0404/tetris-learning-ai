...
QUAL_SEED_START = 3101
QUAL_GAMES = 20
CHAMPION_LABEL = "champion_30k_raw"
CHALLENGER_LABEL = "v8_8_150k_norm"

MODEL_SPECS = [
    (CHAMPION_LABEL, "models/v8_5_risk_aware_observable_safe_td_30k.pt", "raw", 0.060),
    (CHALLENGER_LABEL, "models/v8_8_jax_vectorized_td_150k.pt", "norm", 0.600),
]
...
def main():
    ...
    ap.add_argument("--cache", default="data/v8_8_150k_qualification_3101_3120.json")
    args = ap.parse_args()

    seeds = list(range(3101, 3121))
    ...
    print("=" * 80)
    print("V8.8 150K FRESH FORMAL QUALIFICATION — 3101..3120")
    print("=" * 80)
    print("Formal Champion : V8.5 30K @ RAW gate 0.060")
    print("Challenger      : V8.8 150K @ NORMALIZED gate 0.600")
    ...
    if ok:
        ...
        print("V8.8 150K qualifies to replace V8.5 30K as formal Champion.")
    else:
        print("FINAL RESULT: PROMOTION FAIL")
        print("Retain V8.5 30K as formal Champion.")

    print("Seeds 3101~3120 are now QUALIFICATION-CONSUMED. Do not use them for tuning.")
