...
def save_checkpoint(
    *,
    ...
    torch.save(
        {
            "version": (
                "V8_5_RISK_AWARE_OBSERVABLE_SAFE_"
                "AUTOBATCH_CONSERVATIVE_DDQN"
            ),
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Risk-aware observable-safe continuation from V8.4-20K to a 30K "
            "V8.5 challenger with CUDA batch autotuning and fresher actors."
        )
    )

    parser.add_argument(
        "--checkpoint",
        default="models/v8_4_observable_safe_td_20k.pt",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.085,
        help="Normal actor behavior gate, frozen from 20K development tuning.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=2035712,
        help="Approximate total replay samples to process in this 10K continuation.",
    )
    ...
    print()
    print("=" * 80)
    print("V8.5 RISK-AWARE OBSERVABLE-SAFE 20K -> 30K AUTOBATCH RESUME")
    print("=" * 80)
    print()
    print("Device:", device)
    ...
    print("  CUDA batch 1024/2048/4096 autotuned at startup")
    ...
    print()
    print("=" * 80)
    print("V8.5 RISK-AWARE OBSERVABLE-SAFE 30K TRAINING SUMMARY")
    print("=" * 80)
    print()
    ...
    print()
    print("V8.5 RISK-AWARE OBSERVABLE-SAFE 30K CHALLENGER TRAINING: PASS")
