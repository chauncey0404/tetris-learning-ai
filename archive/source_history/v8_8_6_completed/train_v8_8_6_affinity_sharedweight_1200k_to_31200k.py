...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "V8.8.6: 3-producer affinity + shared-weight CUDA Graph training "
    ...
    parser.add_argument(
        ...
        default=30000000,
        help=(
            "NEW transitions; production V8.8.6 continues the clean "
            "V8.8.3 1.2M challenger to total 31.2M."
        ),
    )
    parser.add_argument(
        "--start-seed",
        type=int,
        default=17001,
        help="V8.8.6 training stream seed base; disjoint from prior/evaluation blocks.",
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "30,000,000 new transitions = 745,200 gradients at batch 8192."
        ),
    )
    ...
    parser.add_argument(
        "--checkpoint-prefix",
        default="models/v8_8_6_affinity_sharedweight_cuda_graph_td",
    )
    parser.add_argument(
        "--max-batch-fraction",
        type=float,
    ...
    print()
    print("=" * 80)
    print("V8.8.6 3-PRODUCER AFFINITY + SHARED-WEIGHT CUDA-GRAPH TRAINING")
    print("=" * 80)
    print()
    ...
    print()
    print("V8.8.6 3-PRODUCER AFFINITY + SHARED-WEIGHT CUDA-GRAPH TRAINING: PASS")
    print(
