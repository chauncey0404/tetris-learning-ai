...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "V8.8.4: hardware-saturation JAX rollout + dynamic-mask CUDA Graph "
    ...
    parser.add_argument(
        ...
        default=10000000,
        help=(
            "NEW transitions; V8.8.4 hardware-saturation run "
            "continues 1.2M -> 11.2M."
        ),
    )
    parser.add_argument(
        "--start-seed",
        type=int,
        default=15001,
        help="V8.8.4 training stream seed base; kept disjoint from all evaluation blocks.",
    )
    ...
    parser.add_argument(
        ...
        default=256,
        help=(
            "Hardware-saturation default. Prior JAX core sweep peaked near 256; "
            "10M new transitions still gives ~39K nominal steps per initial stream."
        ),
    )
    parser.add_argument(
        "--risk-streams",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "10,000,000 new transitions = 248,400 gradients at batch 8192."
        ),
    )
    ...
    parser.add_argument(
        "--checkpoint-prefix",
        default="models/v8_8_4_hardware_saturation_cuda_graph_td",
    )
    parser.add_argument(
        "--max-batch-fraction",
        type=float,
    ...
    parser.add_argument(
        "--output",
        default="models/v8_8_4_hardware_saturation_cuda_graph_td_11200k.pt",
    )
    parser.add_argument(
        "--parity-stamp",
    ...
    print()
    print("=" * 80)
    print("V8.8.4 HARDWARE-SATURATION CUDA-GRAPH TRAINING")
    print("=" * 80)
    print()
    ...
    print()
    print("V8.8.4 HARDWARE-SATURATION CUDA-GRAPH TRAINING: PASS")
    print(
